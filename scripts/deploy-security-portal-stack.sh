...
PORTAL_EGRESS_INSTANCE_ID="${PORTAL_EGRESS_INSTANCE_ID:-i-09c656a6f462df4f2}"
...
CASE_DATABASE_SECRET_ID="${CASE_DATABASE_SECRET_ID:-arn:aws:secretsmanager:ap-northeast-2:063455554839:secret:rds!db-0828cde9-7f5c-4892-b712-af4012dec8a6-lCeVh0}"
